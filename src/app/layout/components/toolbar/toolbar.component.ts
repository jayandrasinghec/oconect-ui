...
export class ToolbarComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this.profileName = this.userInfo.firstname ? `${this.userInfo.firstname}' '${this.userInfo.lastname}` : this.userInfo.username;
    ...
    profileClickHandler(event){
        this.router.navigateByUrl('dashboard/member/profile');
